...
Miagent.io is free and open-source. You can test it online at https://marmelab.com/atomic-crm-demo.
...
- ✉️ **Capture Emails**: CC Miagent.io to automatically save communications as notes.
...
## Customizing Miagent.io

To customize Miagent.io, you will need TypeScript and React programming skills as there is no graphical user interface for customization. Here are some resources to assist you in getting started.
...
Miagent.io components are published as a Shadcn Registry file:
