...
const SettingsForm = ({
  ...
  Bạn có thể bắt đầu gửi email đến địa chỉ email inbound của máy chủ,
  ví dụ bằng cách thêm địa chỉ này vào trường
  <b> Cc: </b>. Miagent.io sẽ xử lý các email này và tự động thêm ghi chú
  vào các liên hệ tương ứng.
</p>
