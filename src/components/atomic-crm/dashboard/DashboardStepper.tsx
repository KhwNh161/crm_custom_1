        ...
        <CardContent className="px-6">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex gap-8 items-center">
              ...
              <h4 className="font-bold">Cài đặt Miagent.io</h4>
            </div>
            <div className="flex gap-8 items-start">
              ...
              <div className="flex flex-col gap-4">
                <h4 className="font-bold">Thêm liên hệ đầu tiên của bạn</h4>
            ...
            <div className="flex gap-8 items-start">
              <Circle className="text-muted-foreground w-5 h-5 mt-1" />
              <div className="flex flex-col gap-4">
                <h4 className="font-bold">Thêm ghi chú đầu tiên</h4>
                <p>Đi đến trang liên hệ và thêm ghi chú</p>
                <Button asChild disabled={step < 2} className="w-[100px]">
                  <Link to={`/contacts/${contactId}/show`}>Thêm ghi chú</Link>
                </Button>
              </div>
            </div>
          </div>
