...
const CompanyContactInputs = () => {
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Liên hệ</h6>
...
const CompanyContextInputs = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Thông tin</h6>
      <SelectInput
        source="sector"
...
const CompanyAddressInputs = () => {
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Địa chỉ</h6>
...
const CompanyAdditionalInformationInputs = () => {
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Thông tin bổ sung</h6>
...
const CompanyAccountManagerInput = () => {
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Người quản lý tài khoản</h6>
      <ReferenceInput
        source="sales_id"
        reference="sales"
        filter={{
