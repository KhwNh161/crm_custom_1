...
const ContactIdentityInputs = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Danh tính</h6>
...
const ContactPositionInputs = () => {
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Chức vụ</h6>
...
const ContactPersonalInformationInputs = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Thông tin cá nhân</h6>
      <ArrayInput
        source="email_jsonb"
        label="Địa chỉ email"
        helperText={false}
      ...
      <ArrayInput source="phone_jsonb" label="Số điện thoại" helperText={false}>
        <SimpleFormIterator
          inline
          disableReordering
          disableClear
...
const ContactMiscInputs = () => {
  return (
    <div className="flex flex-col gap-4">
      <h6 className="text-lg font-semibold">Khác</h6>
      <TextInput
        source="background"
        label="Thông tin nền (tiểu sử, cách bạn gặp, v.v.)"
        multiline
        helperText={false}
      />
