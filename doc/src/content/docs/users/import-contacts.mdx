...
description: This document explains how to import and export contacts in Miagent.io.
---
...
Miagent.io displays an import contact buttons in the initial user onboarding page, and in the contacts page. When clicking on it, a modal is displayed to upload a CSV file.
