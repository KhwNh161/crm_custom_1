...
description: This document explains how to manage users in Miagent.io.
---

## Creating the First User

The first time you open the Miagent.io App, you will be prompted to create the first user. This first user will automatically be granted administrator role.
