...
description: This document explains the data providers used in the development of Miagent.io.
---

By default, the Miagent.io uses [Supabase](https://supabase.com) for the backend API. Supabase is an open-source alternative to Firebase, built on top of Postgres. It provides a REST API and a real-time subscription system. The generous free tier allows you to run a small CRM for free.

## Using Test Data

Developing features with an empty database can be challenging. To help with this, Miagent.io includes a CSV file with test data that can be imported into the application.
...
:::tip
FakeRest is used in the [Miagent.io demo](https://marmelab.com/atomic-crm-demo/), where you can test it live.
:::
