...
description: This document explains how to configure inbound email processing in Miagent.io.
---
...
Miagent.io uses [Postmark](https://postmarkapp.com/) to receive and process inbound emails.
...
Miagent.io uses a Supabase Edge Function to handle the webhook and process the received emails. You need to configure your Supabase project to handle the incoming requests.
