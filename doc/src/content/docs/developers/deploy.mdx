---
title: Deploying Miagent.io to Production
description: This document explains how to deploy Miagent.io to production.
---

## Deploying The Backend

The entire backend of Miagent.io is hosted on Supabase. The backend is composed of a Postgres database, a REST API, and edge functions. Check out the [Supabase Configuration](./supabase-configuration) section for details.
...
Miagent.io contains GitHub actions for continuous integration and delivery. To enable these actions, you will
...
> **Note:** The `POSTMARK_*` variables are required for Miagent.io's inbound email features. Have a look at the the [inbound email configuration](./inbound-email-configuration) to learn more about their usage and setup.
